...
const PIPELINE_STEPS = [
  ...
  { icon: MessageSquareText, label: 'Genie Instructions' },
...
export default function LandingPage({ onStart, onOpenSetup }) {
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-2xl" style={{ borderBottom: `1px solid ${C.navBorder}`, backgroundColor: C.navBg }}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-semibold text-[#FF3621] border border-[#FF3621]/30 bg-[#FF3621]/10 rounded-full px-2 py-0.5">V9</span>
          </div>
          {/* Section indicators */}
          <div className="hidden md:flex items-center gap-1.5">
            {['Discover', 'Analyze', 'Pipeline', 'Agent', 'Results', 'Get Started'].map((label, i) => (
              <button
                key={label}
                onClick={() => {
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <aside className="mt-5 max-w-lg space-y-3" aria-label="Setup and legal disclaimer">
                  <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-sm" style={{ color: C.textFaint }}>
                    ...
                    <span>Use the setup wizard for host, token, warehouse, and Inspire database.</span>
                    {onOpenSetup && (
                      <button
                        type="button"
                        onClick={onOpenSetup}
                        className="text-[#FF3621] font-medium hover:underline ml-1"
                      >
                        Workspace setup
                      </button>
                    )}
                  ...
                  <p
                    className="text-[10px] sm:text-[11px] leading-relaxed border-t border-white/8 pt-3"
                    style={{ color: C.textFaint }}
                  >
                    This software is provided as-is and is not officially supported by Databricks through customer
                    technical support channels. Support, questions, and feature requests can be communicated through the
                    Issues page of this repo. Issues with the use of this code will not be answered or investigated by
                    Databricks Support.
                  </p>
                </aside>
              </div>
        ...
        <section className="h-screen snap-start relative flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto px-6">
            ...
            <p className={`mb-10 transition-all duration-700 delay-200 ${section >= 5 ? 'opacity-100' : 'opacity-0'}`} style={{ color: C.textMuted }}>
              Get started and generate your first analytics strategy in under 30 minutes.
            </p>
