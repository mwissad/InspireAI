...
# The Databricks App runtime automatically injects DATABRICKS_CLIENT_ID and
# DATABRICKS_CLIENT_SECRET for the SP declared in app.yaml resources section.
# The backend uses these to generate OAuth tokens via client_credentials flow.
# No need to create secrets manually — the runtime handles it.
